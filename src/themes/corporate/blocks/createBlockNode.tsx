...
interface CreateBlockNodeOptions<TAttrs> {
  // Sub-id under the theme namespace, e.g. "hero-overlay".
  // The full block id is `corporate/<subId>`. Tiptap node name is
...
// Builds a Tiptap atom node tied to a corporate theme block. Mirrors
// the createBlockNode helper in the magazine theme — identical
// implementation, corporate namespace.
